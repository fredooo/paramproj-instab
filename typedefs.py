...
DataSplit = namedtuple("DataSplit", ["X_tr", "y_tr", "X_val", "y_val", "X_te", "y_te"])

# Output from projection evaluation (passed to NN evaluation)
ProjectionContext = namedtuple(
    "ProjectionContext",
    ["reducer", "Z_tr", "Z_val", "Z_te", "supports_transform", "X_base", "Z_base", "X_noisy_per_class"],
)
...
TrainingResult = namedtuple(
    "TrainingResult", ["model", "best_val_loss", "final_train_loss", "epochs", "early_stopped", "training_time"]
)
